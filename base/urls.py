...
path('admin/registration/<int:registration_id>/', views.get_registration_details, name='get_registration_details'),
...
path('register/', views.register_program, name='register_course'),
